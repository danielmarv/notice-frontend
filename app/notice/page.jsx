      ...
      <article className="px-4 py-5 mx-auto max-w-7xl">
          <div className="w-full mx-auto mb-12 text-left md:w-3/4 lg:w-1/2">
              ...
              <div className="avatar">
                  ...
                  src={`http://localhost:1337${notice.attributes.image.data.attributes.url}`}
                  alt={"Photo of " + notice.attributes.recruiter} />
              </div>
              <div className="ml-4">
                  <p className="font-semibold text-gray-800 text-md">{notice.attributes.recruiter}</p>
          ...
          <div className="flex flex-col items-center justify-center mt-10 space-x-0 space-y-2 md:space-x-2 md:space-y-0 md:flex-row">
               <Link href="/notices"><a href="" className="px-3 py-2 text-indigo-500 border border-indigo-500 border-solid hover:text-black md:w-auto">Back</a>
               </Link>
           </div>
      </article>
      </>
